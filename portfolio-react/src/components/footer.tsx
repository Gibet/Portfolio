...
const Footer: React.FC<HeaderProps> = (props: HeaderProps) => {
  return (
    <footer className='backdrop-blur-xs w-full 2xl:max-w-[75vw] grid grid-cols-2 justify-center items-center text-center pt-6'>
      <div className='col-span-1 flex flex-col justify-self-center w-full px-4 items-start gap-2'>
        ...
        <ul className='text-left w-full text-xs grid grid-cols-2 md:grid-cols-3 gap-3 text-nowrap'>
          <li className='col-span-1'><button onClick={() => props.navigate('home')}><Home size={14} strokeWidth={ 1} /><span>Accueil</span></button></li>
          <li className='md:col-span-2 col-span-1'><button onClick={() => props.navigate('about')}><Info size={14} strokeWidth={ 1} /><span>À propos</span></button></li>
          <li className='col-span-1'><button onClick={() => props.navigate('projects')}><Cog size={14} strokeWidth={ 1} /><span>Projets</span></button></li>
          <li className='col-span-1'><button onClick={() => props.navigate('contact')}><Contact size={14} strokeWidth={ 1} /><span>Contact</span></button></li>
        </ul>
      </div>
      <div className='col-span-1 flex flex-col justify-self-center w-full px-4 items-start gap-2'>
